...
public class StatAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        balsots.setText("Kopâ bilþu: "+song.get(Statistika.KEY_BILDES));
        nebalsots.setText("Kopâ balsu: "+song.get(Statistika.KEY_BALSIS));
        albums.setText("Kopâ albumu: "+song.get(Statistika.KEY_ALBUMI));
        reitings.setText("Bildes skatîtas "+song.get(Statistika.KEY_SKAITS+" reizes"));
        return vi;
    }
}